        ...
        <div class="row align-items-center h-100">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <p
              ...
              HI, I'm Ratchanon Thanatsang
              <br />
              A Computer Engineer Student
              <br />
              CTO & Co-Founder of THEBANDM
            </p>
            <p
              class="hidden lg:block text-2xl mb-5">
              I am deeply passionate about the dynamic synergy of technology and business. The innovative tech landscape and strategic business challenges fuel my boundless curiosity and drive for growth and positive change
            </p>
